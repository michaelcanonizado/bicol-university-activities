...
int main() {
    ...
    // Another variable is need as this variable will contain the verified and transformed letter. But the original input is still needed, as it is going to be the one used to printed out with the lyrics. As shown in the example in the instructions. E.g. 
